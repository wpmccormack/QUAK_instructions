...
class QUAKRunner:
    ...
    def makeH5s(self, jmevar=0):
        ...
        loss2 = -1*branches['loss1'] #bkg_loss
        ...
        loss2_bkg = -1*branches2['loss1'] #bkg_loss
        ...
        print("sig loss average =", np.average(loss1), " and std ", np.std(loss1))
        """
        ...
        """
        self.sigOffset = np.average(loss1) - np.std(loss1)
        print("self.sigOffset = ", self.sigOffset)
        #loss1 = loss1 - self.sigOffset
        loss1 = loss1 + 2.
