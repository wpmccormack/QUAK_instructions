...
os.system("xrdcp -fs root://cmseos.fnal.gov//store/user/wmccorma/CASE_SIGNAL_EFFICIENCIES_AND_SYSTEMATICS/"+json_object[str(options.key)]["samSignalName"]+"/"+json_object[str(options.key)]["samSignalName"]+"_selectionEfficiency.json .")
os.system("xrdcp -fs root://cmseos.fnal.gov//store/user/wmccorma/CASE_SIGNAL_EFFICIENCIES_AND_SYSTEMATICS/"+json_object[str(options.key)]["samSignalName"]+"/"+json_object[str(options.key)]["samSignalName"]+"_signalSystematic.json .")
...
os.system("xrdcp -fs runningLimitsDir/"+json_object[str(options.key)]["specificSignalName"]+".json root://cmseos.fnal.gov//store/user/wmccorma/CASE_GENERIC_LIMITS/")
os.system("xrdcp -fs runningLimitsDir/"+json_object[str(options.key)]["specificSignalName"]+".json root://cmseos.fnal.gov//store/user/wmccorma/CASE_GENERIC_LIMITS/"+json_object[str(options.key)]["samSignalName"]+"/")
os.system("xrdcp -fs runningLimitsDir/"+json_object[str(options.key)]["specificSignalName"]+"_noSyst.json root://cmseos.fnal.gov//store/user/wmccorma/CASE_GENERIC_LIMITS/"+json_object[str(options.key)]["samSignalName"]+"/")
