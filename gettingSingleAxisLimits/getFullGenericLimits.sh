...
xrdcp -s root://cmseos.fnal.gov//store/user/wmccorma/masterJson.json .
...
xrdcp -s root://cmseos.fnal.gov//store/user/wmccorma/limitGetter_singleAxis.py .

python limitGetter_singleAxis.py -k ${2}
