...
os.system("xrdcp -fs runningEffDir/"+json_object[str(options.key)]["samSignalName"]+"_selectionEfficiency.json root://cmseos.fnal.gov//store/user/wmccorma/CASE_SIGNAL_EFFICIENCIES_AND_SYSTEMATICS/"+json_object[str(options.key)]["samSignalName"]+"/")
os.system("xrdcp -fs runningSystDir/"+json_object[str(options.key)]["samSignalName"]+"_signalSystematic.json root://cmseos.fnal.gov//store/user/wmccorma/CASE_SIGNAL_EFFICIENCIES_AND_SYSTEMATICS/"+json_object[str(options.key)]["samSignalName"]+"/")
